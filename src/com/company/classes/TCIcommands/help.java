...
public class help implements TCICommands {
    ...
    private enum test {
        DEFAULT{
            public String run(){
                return "Введите /slots - для игры в слоты \nВведите /kreps - для игры в крепс \nВведите /info - для всей доступной информации об игроке\nВведите /help \"command name\" - для дополнительной справки о комманде \n\nTips:\nQ:как получить статус ?\nA: попросить администрацию и возможно вам его выдадут";
            }
        },
        ...
        kreps{
            public String run() {
                return ("1 этап игры: Игрок бросает 1 12-гранный кубик. Игрок имеет возможность ставить на pass или dpass с выигрышем х2, если игрок поставил на pass и выиграл, начинается второй этап игры.\n"+
        ...
        slots{
            public String run(){
                return ("Игрок вводит число ставки. При выпадениее 2 одинаковых чисел выигрыш х2, а при выпадении 3 одинаковых чисел подряд выигрыш х7.\n"+
        ...
        help{
            public String run(){
                return "\"/help\" - комманда выводящая справку";
            }
        };
    ...
    public void execute(String[] data) {
        ...
        if (data.length == 0){
            TCI.sendMsg(test.DEFAULT.run(), playerDataShell.getPlayerData().telegramID, "commands");
        } else {
            TCI.sendMsg(test.get(data[0]).run(), playerDataShell.getPlayerData().telegramID, "commands");
        }
    }
}
